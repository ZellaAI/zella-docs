---
title: "Intro"
description: "Zella inference routers bring ease and reliability to AI usage.
...
Each Zella Router features a primary model, which is your first point of contact for every request.
...
Zella Routers put you in the driver's seat. Customize model-level configurations for each of your
primary and fallback models, ensuring the AI performs exactly as you require.

## Effortless Access

Once your Zella Router is set up, you can access it using its unique identifier. This makes integrating
it into your projects as straightforward as using any standard model in the Zella Gateway.

## In Conclusion

Zella Routers are designed to simplify and personalize your AI experience. They are ideal for anyone
