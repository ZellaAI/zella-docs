...
model or prompt on which you want to conduct the experiment. This initial setup lays the
...
for the selected Zella model or prompt. Here, you can choose from existing variations or create
