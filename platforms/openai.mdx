---
title: OpenAI
description: Integrate with OpenAI using Zella Gateway.
---

## Get Started
Begin by setting up an account on [Zella AI](https://zella.ai/).
Simply link your OpenAI access token in Zella to obtain a Zella access token, which you'll use for API requests.
